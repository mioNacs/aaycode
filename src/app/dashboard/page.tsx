		...
		<main className="container flex min-h-[70vh] flex-col justify-center gap-10 py-16">
			<section className="card space-y-4 p-10">
				<div className="space-y-2">
					...
					<p className="text-sm text-neutral-500">
						Signed in as {session.user.email ?? "your connected account"}. Manage your public presence and keep your
						profile up to date.
					</p>
				</div>
				{username ? <ProfileShareLink username={username} /> : null}
			</section>
			...
			<section className="card max-w-2xl space-y-4 p-10">
				<div className="space-y-2">
					...
					<p className="text-sm text-neutral-500">
						Usernames help others find your public profile. They can be changed at any time, as long as they remain unique
